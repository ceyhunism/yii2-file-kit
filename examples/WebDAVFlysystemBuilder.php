 ...
 * @link https://github.com/ceyhunism/yii2-file-kit/issues/46
 */
class WebDAVFlysystemBuilder implements FilesystemBuilderInterface
{
    ...
    public function build()
    {
        ...
        \yii\base\Event::on(\ceyhunism\filekit\Storage::className(), \ceyhunism\filekit\Storage::EVENT_BEFORE_SAVE, function ($event) {
            /** @var \ceyhunism\filekit\Storage $storage */
